...
@Entity
public class ReglementSodeci {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
    private long idRgSodeci;
	...
	public ReglementSodeci() {
		super();
		// TODO Auto-generated constructor stub
	}
	public ReglementSodeci(long idRgSodeci, String codmvt, String typmvt, String codexp, String idabon, String perfact,
			String typfact, String sens, String numfact, String refbranch, Date dateEnr, Date heureEnr, Date dateRegle,
			Date heureRegle, int montantRegle, String numeroRecu, String typeCanal, String idabon2, String statut) {
		super();
		this.idRgSodeci = idRgSodeci;
		this.codmvt = codmvt;
		this.typmvt = typmvt;
		this.codexp = codexp;
		this.idabon = idabon;
	...
	public ReglementSodeci(String codmvt, String typmvt, String codexp, String idabon, String perfact, String typfact,
			String sens, String numfact, String refbranch, Date dateEnr, Date heureEnr, Date dateRegle, Date heureRegle,
			int montantRegle, String numeroRecu, String typeCanal, String idabon2, String statut) {
		super();
		this.codmvt = codmvt;
		this.typmvt = typmvt;
		this.codexp = codexp;
	...
	public long getIdRgSodeci() {
		return idRgSodeci;
	}
	public void setIdRgSodeci(long idRgSodeci) {
		this.idRgSodeci = idRgSodeci;
	}
	...
	public String toString() {
		return "ReglementSodeci [idRgSodeci=" + idRgSodeci + ", codmvt=" + codmvt + ", typmvt=" + typmvt + ", codexp="
				+ codexp + ", idabon=" + idabon + ", perfact=" + perfact + ", typfact=" + typfact + ", sens=" + sens
